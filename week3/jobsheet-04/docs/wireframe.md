...
|   NIM / NIK      : [________________________]               |
...
### 2. User Flow: Pencarian Anggota Berstatus Terlambat
[Petugas Login] -> [Dashboard] -> [Menu Transaksi/Riwayat] -> [Filter Status: Terlambat] -> [Sistem Menampilkan Daftar Anggota Terlambat] -> [Pilih Anggota & Lihat Detail Denda]

### 3. Edge Case Tambahan
- **Kasus:** Meminjamkan buku yang sama ke anggota yang sama 2x berturut-turut sebelum buku pertama dikembalikan.
- **Penanganan UX:** Sistem melakukan pengecekan transaksi aktif. Jika buku yang dipilih sudah dipinjam dan belum dikembalikan oleh anggota tersebut, tombol simpan dinonaktifkan dan menampilkan pesan peringatan.